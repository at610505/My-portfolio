...
export default function Projects() {
  return (
    <section>
      <div className="m-5 md:mx-60 md:my-10">
        <div className="animation-marquee">
          This Section is under development, I will add Some New feature in near
          Future :)
        </div>
        <h1 className="text-4xl font-bold my-10">Featured Projects</h1>
        ...
        <div id="card" className="block md:flex my-5">
          ...
          <div className="md:basis-4/5 md:mx-4">
            <a
              href="https://url-shortner-frontend-sage.vercel.app"
              target="_blank"
            >
        ...
        <div id="card" className="block md:flex my-5">
          ...
          <div className="md:basis-4/5 md:mx-4">
            <a href="https://secret-frontend-kohl.vercel.app/" target="_blank">
